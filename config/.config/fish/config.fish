...
alias lt 'lsd -a --depth 3 --tree --color=always --group-directories-first' # tree listing
alias llt 'lsd --depth 4 --tree --color=always --group-directories-first' # tree listing
alias l. 'lsd -ald --color=always --group-directories-first .*' # show only dotfiles


# Replace some more things with better alternatives
# abbr cat 'bat --style header,snip,changes'
# 20260201 - removed the above style to just use default
abbr cat 'bat'
