...
-- Set default tabstop/shiftwidth (but vim-sleuth will takeover)
vim.opt.tabstop = 4
...
vim.keymap.set("i", "jk", "<C-\\><C-n>", { desc = "Exit terminal mode" })
	...
	{ "Bilal2453/luvit-meta", lazy = true },
	{
		...
		config = function()
			...
			local servers = {
				...
				-- gopls = {},
				-- pyright = {},
				-- rust_analyzer = {}, -- rustaceanvim plugin should handle this (in custom/plugins/rust.lua)
	...
	{ -- Collection of various small independent plugins/modules
		...
		config = function()
			...
			require("mini.surround").setup({
				-- Replacing with 'z' as these are used less often and prefer "s<chars>" for nvim-sneak (lua/custom/init.lua)
			...
			-- NOTE: Using nvim-lualine instead (venv-selector had an integration with it to show venv)
			--
			...
			-- NOTE: Used along with indent-blankline from kickstart/plugins to show current indent
			-- TODO: Get them to integrate better or just use!
